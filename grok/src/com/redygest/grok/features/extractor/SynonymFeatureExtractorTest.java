...
public class SynonymFeatureExtractorTest extends TestCase{
	...
	private IFeatureExtractor ner_extractor = FeatureExtractorFactory.getInstance().getFeatureExtractor(FeatureExtractorType.NER);
	private IFeatureExtractor syn_extractor = FeatureExtractorFactory.getInstance().getFeatureExtractor(FeatureExtractorType.DBSYNONYM);
	...
	public void testSynonym(){
		...
		if(var != null) {
			...
			List<String> synonym = attrs.getAttributeNames(AttributeType.SYNONYM);
