...
public class TwitterPreprocessor implements DataPreProcessor {
	private List<String> sentences = new ArrayList<String>();
	
	public Data preprocess(Data t) {
		String text = t.getValue(DataType.BODY);
		List<String> tokenizeLines = tokenize(text);
		StringBuilder processedText = new StringBuilder();
		for(String line : tokenizeLines) {
			processedText.append(line);
			processedText.append(" ");
		}
		t.setValue(DataType.BODY, processedText.toString().trim());
		return t;
	}
